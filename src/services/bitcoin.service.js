...
async function getCoinsForPreview() {
  try {
    // const { data } = await axios.get(`https://pro-api.coinmarketcap.com/v2/cryptocurrency/quotes/latest?id=1`, {
    //     headers: {
    //         'X-CMC_PRO_API_KEY': API_KEY,
    ...
    // });
    // const price = financial((data.data['1'].quote.USD.price), 3);
    let btc = coinData.data[0]
    btc.image = 'https://res.cloudinary.com/dubjerksn/image/upload/v1645126118/Stuff/swwq4hvqiylh6kroj7e7.png'
    let eth = coinData.data[1]
    eth.image = 'https://res.cloudinary.com/dubjerksn/image/upload/v1645126118/Stuff/f2eqlr1i2a1qwczbnrkp.png'
    let bnb = coinData.data[3]
    bnb.image = 'https://res.cloudinary.com/dubjerksn/image/upload/v1645126118/Stuff/fpab4fchj39dlsx4wkae.png'
    let avax = coinData.data[9]
    avax.image = 'https://res.cloudinary.com/dubjerksn/image/upload/v1645126118/Stuff/azpfo8tak19juviul0ns.png'
    let coinsArray = [btc, eth, bnb, avax]
    return coinsArray
  } catch (err) {
    console.log('cannot load coins', err);
    throw err
...
async function getCoinNews() {
  try {
    ...
    //     'x-api-key': 'i69bQIzyxN4TIdORfC5AlaySeFrCXRJ76kigEFxK'
    //   }
    // };
    // let data = await axios(options)
    // console.log('data', data)
    return coinNews.body

  } catch (err) {
    console.log('cannot fetch coin news', err);
  }
  ...
  "body": [
    {
      ...
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-17T00:00:00Z",
      "categories": [
        {
          "id": 1,
          "name": "Release"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/63ab1e33cdfa8b29c49df2163e2912b7.png",
      "source": "https://coinmarketcal.com/event/adadao-public-sale-106791"
    },
    {
      "id": 105532,
      "title": {
        "en": "Twitter Community Space"
      },
      "coins": [
        {
          "id": "everrise",
      ...
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-08T16:46:45Z",
      "categories": [
        {
          "id": 9,
          "name": "AMA"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/291f8a015dd194ce38542773f5e409bd.png",
      "source": "https://coinmarketcal.com/event/twitter-community-space-105532"
    },
    {
      "id": 106055,
      "title": {
      ...
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-12T21:40:13Z",
      "categories": [
        {
          "id": 9,
          "name": "AMA"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/8f4f35f80c1c2e927df5a5d65adaa062.png",
      "source": "https://coinmarketcal.com/event/ama-106055"
    },
    {
      "id": 106550,
      "title": {
        "en": "Mina Spotlight Event"
      },
      "coins": [
        {
          "id": "mina-protocol",
      ...
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-16T07:07:31Z",
      "categories": [
        {
          "id": 16,
          "name": "Team Update"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/0cd89dafb195370f482f170ccb85d2e0.png",
      "source": "https://coinmarketcal.com/event/mina-spotlight-event-106550"
    },
    {
      "id": 104834,
      "title": {
      ...
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-02T18:12:23Z",
      "categories": [
        {
          "id": 7,
          "name": "Other"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/7cf1a936f1a88f52dfe1691da483c0ed.png",
      "source": "https://coinmarketcal.com/event/battle-verse-igo-104834"
    },
    {
      "id": 106069,
      "title": {
      ...
      "coins": [
        {
          ...
          "rank": 487,
          "symbol": "ERN",
          "fullname": "Ethernity Chain (ERN)"
        }
      ],
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-12T21:50:45Z",
      "categories": [
        {
          "id": 1,
          "name": "Release"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/eebed721e96e65121da703107e915f0d.png",
      "source": "https://coinmarketcal.com/event/nft-drop-106069"
    },
    {
      "id": 106283,
      "title": {
        "en": "Telegram AMA w/ BitYard"
      },
      "coins": [
        {
          "id": "floki-inu",
      ...
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-14T12:37:35Z",
      "categories": [
        {
          "id": 9,
          "name": "AMA"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/87e8721c931dbbb6b8b51f4553a2d68a.png",
      "source": "https://coinmarketcal.com/event/telegram-ama-w-bityard-106283"
    },
    {
      "id": 106492,
      "title": {
      ...
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-15T12:50:48Z",
      "categories": [
        {
          "id": 4,
          "name": "Exchange"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/e24da2359a2b230099ff2b5168d2badc.png",
      "source": "https://coinmarketcal.com/event/indodax-listing-106492"
    },
    {
      "id": 106720,
      "title": {
        "en": "Penguin & Avaxtars AMA"
      },
      "coins": [
        {
          "id": "avaxtars",
        ...
        },
        {
          ...
          "rank": 1325,
          "symbol": "PEFI",
          "fullname": "Penguin Finance (PEFI)"
        }
      ],
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-16T20:44:38Z",
      "categories": [
        {
          "id": 9,
          "name": "AMA"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/bc49eadbfe81ce1b9cc8c61f89dda14a.png",
      "source": "https://coinmarketcal.com/event/penguin-avaxtars-ama-106720"
    },
    {
      "id": 106676,
      "title": {
      ...
      "coins": [
        ...
        },
        {
          ...
          "rank": 829,
          "symbol": "YAK",
          "fullname": "Yield Yak (YAK)"
        }
      ],
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-16T14:09:25Z",
      "categories": [
        {
          "id": 6,
          "name": "Meetup"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/9c5b7fb094c8396c3041149932ad49f8.png",
      "source": "https://coinmarketcal.com/event/twitter-spaces-106676"
    },
    {
      "id": 106143,
      "title": {
        "en": "Connected Vehicles Panel"
      },
      "coins": [
        {
          "id": "fetch",
      ...
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-14T03:46:50Z",
      "categories": [
        {
          "id": 7,
          "name": "Other"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/6784fc36446b9c454956bb418b1e6903.png",
      "source": "https://coinmarketcal.com/event/connected-vehicles-panel-106143"
    },
    {
      "id": 106519,
      "title": {
      ...
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-16T04:35:44Z",
      "categories": [
        {
          "id": 4,
          "name": "Exchange"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/be24cd769e32cb86d8a1dc1adafbc12c.png",
      "source": "https://coinmarketcal.com/event/kraken-listing-106519"
    },
    {
      "id": 106486,
      "title": {
        "en": "Telegram AMA w/ Bybit"
      },
      "coins": [
        {
          "id": "nervos-network",
      ...
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-15T13:35:27Z",
      "categories": [
        {
          "id": 9,
          "name": "AMA"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/95d156415f1daf47b34073a26f0cc8c3.png",
      "source": "https://coinmarketcal.com/event/telegram-ama-w-bybit-106486"
    },
    {
      "id": 106657,
      "title": {
        "en": "MEXC Global Listing"
      },
      "coins": [
        {
          "id": "bitshiba",
          ...
          "rank": 0,
          "symbol": "SHIBA",
          "fullname": "BitShiba (SHIBA)"
        }
      ],
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-16T12:52:25Z",
      "categories": [
        {
          "id": 4,
          "name": "Exchange"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/5ca9857c264bcb1ea59e7555f6bfc0d9.png",
      "source": "https://coinmarketcal.com/event/mexc-global-listing-106657"
    },
    {
      "id": 106122,
      "title": {
        "en": "DRIVENlock Launch"
      },
      "coins": [
        {
          "id": "drivenx",
          ...
          "rank": 0,
          "symbol": "DVX",
          "fullname": "DRIVENx (DVX)"
        }
      ],
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-12T22:28:26Z",
      "categories": [
        {
          "id": 1,
          "name": "Release"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/c2b22712a6ef3adee3502d051a0fa6a7.png",
      "source": "https://coinmarketcal.com/event/drivenlock-launch-106122"
    },
    {
      "id": 106502,
      "title": {
        "en": "Synapse Summit 2022"
      },
      "coins": [
        {
          "id": "celsius",
      ...
      "date_event": "2022-02-17T00:00:00Z",
      "can_occur_before": false,
      "created_date": "2022-02-16T02:10:54Z",
      "categories": [
        {
          "id": 5,
          "name": "Conference"
      ...
      "proof": "https://d32bfp67k1q0s7.cloudfront.net/d6d3f9dcf36a45834c629c3b39456233.png",
      "source": "https://coinmarketcal.com/event/synapse-summit-2022-106502"
    }
  ]
}